...
//        m.getDefaultDisplay().getMetrics(metrics);
        ...
        int ViewWidth = mContext.getResources().getDisplayMetrics().widthPixels * 4 / 5;
        mRootView = new ListView(mContext);
        mRootView.setFastScrollAlwaysVisible(true);
        mRootView.setVerticalScrollBarEnabled(true);
        ...
        this.setBackgroundDrawable(mContext.getDrawable(R.drawable.list_bc));
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (CurrentIndex == i) {
                holder.progress.setTextColor(mContext.getColor(R.color.colorAccent));
                holder.title.setTextColor(mContext.getColor(R.color.colorAccent));
                holder.index.setTextColor(mContext.getColor(R.color.colorAccent));
                holder.progress.setText("当前");
            } else {
                holder.progress.setTextColor(Color.parseColor("#aeaca2"));
                holder.title.setTextColor(Color.parseColor("#e45e0d"));
                holder.index.setTextColor(Color.parseColor("#5f5f5d"));
                float p = 0;
                if (AllCharNum > 0) {
