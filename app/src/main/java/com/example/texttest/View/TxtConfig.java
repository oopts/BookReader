...
public class TxtConfig {
    ...
    public static final int MID_TEXT_SIZE = 60;
    public static final int MIN_TEXT_SIZE = 10;//in px
    ...
    public int backgroundColor = Color.parseColor("#f2f0dd");
    ...
    public Boolean SwitchByTranslate = true;        //翻页方式
    ...
    public static int getTextSize(Context context) {
        SharedPreferences share = getS(context);
        return share.getInt(C_TEXT_SIZE,MID_TEXT_SIZE);
    }
    ...
    public static int getBackgroundColor(Context context) {
        SharedPreferences share = getS(context);
        return share.getInt(C_BACKGROUND_COLOR, Color.parseColor("#f2f0dd"));
    }
